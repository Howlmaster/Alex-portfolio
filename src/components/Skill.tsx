...
export const Skill = (props: SkillProps) => {
  ...
  return (
    <div className="w-32 mx-auto text-gray-700 dark:text-gray-300 border rounded-lg sm:w-40">
      <div
      ...
      >
        ...
        <div className="relative w-full h-1 mt-8 bg-gray-400 dark:bg-gray-600 rounded">
